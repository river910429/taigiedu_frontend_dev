  ...
  CATEGORY_OPTIONS.forEach(category => {
    ...
    for (let index = 0; index < 18; index += 1) {
      ...
      items.push({
        ...
        imageUrl: null,
        fileUrl: '',
        summary: `本份資源以「${topic}」為情境，整理職場上最常用到的台語說法與對話流程，適合${category}相關從業人員自學或課堂使用。`,
        sections: [
          {
            heading: '一、適用對象',
            body: `${category}相關科系學生、在職人員，以及需要以台語與民眾溝通的第一線工作者。`,
          },
          {
            heading: '二、學習目標',
            body: `能以台語完成「${topic}」情境中的基本問答，並正確使用相關專有名詞與禮貌用語。`,
          },
          {
            heading: '三、內容架構',
            body: `情境導入 → 核心詞彙（約 20 個）→ 對話範例（3 組）→ 角色扮演練習 → 課後自我檢核。`,
          },
        ],
      });
    }
